...
class ToiletsControllerTest < ActionController::TestCase
  ...
  test "should create toilet" do
    assert_difference('Toilet.count') do
      post :create, toilet: { address: @toilet.address, latitude: @toilet.latitude, longitude: @toilet.longitude, name: @toilet.name }
    end
  ...
  test "should update toilet" do
    patch :update, id: @toilet, toilet: { address: @toilet.address, latitude: @toilet.latitude, longitude: @toilet.longitude, name: @toilet.name }
    assert_redirected_to toilet_path(assigns(:toilet))
  end
